...
> **Note:** The ONNX format is an acronym for the **Open Neural Network Exchange** format.  It allows you to convert between various AI persisted formats.  This format is starting to become ubiquitous and facilitates a standard method of persisting a neural network architecture.  For more information on ONNX, please visit: http://onnx.ai/
